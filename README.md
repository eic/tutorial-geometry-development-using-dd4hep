...
An ePIC tutorial on developing detector geometry with the `DD4hep` toolkit: where the ePIC geometry
lives in `eic-shell`, how a geometry description is structured, how to view it, and how to modify or
add to it by writing detector plugins.
